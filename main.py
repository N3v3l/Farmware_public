...
class Netatmo(Farmware):
    ...
    def load_config(self):
        ...
        try:
            ...
            self.sws = self.get_arg('sw', "(46.95,7.42)")
    ...
    def get_access_token(self, login='', password=''):
        ...
        client_id = '5b183782923dfeefaa8b6adf'
        client_secret = 'SQa5AwfdreY5sHIJYyNpbORWvSnVV4MO'
        ...
        if login != '':
            ...
            payload = {'grant_type': 'refresh_token',
                       'refresh_token': '5b183782923dfeefaa8b6adf|SQa5AwfdreY5sHIJYyNpbORWvSnVV4MO',
                       'client_id': client_id,
                       'client_secret': client_secret}
